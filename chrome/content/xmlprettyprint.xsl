...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <link href="chrome://foxmeter/content/xmlprettyprint.css" type="text/css" rel="stylesheet"/>
  ...
  <xsl:template name="expander">
    <div class="expander-display-open" onclick="x(this);"><div class="spacer"></div></div>
  </xsl:template>
